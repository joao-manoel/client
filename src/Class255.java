...
public class Class255 implements Runnable {
	...
	text.setText(date.toString() + "\n\nOh nooo! Jogo Crashou. Se isso continuar ocorrendo, \r\n" + 
		"copie e, em seguida, procure suporte no site/forum ou entre em contato com algum administrador. \n\n\n" + error + "\n\n \r\n" + 
	...
	int click = JOptionPane.showConfirmDialog(null, scrollPane, "Uh oh! Client Crashou.", JOptionPane.OK_OPTION);
