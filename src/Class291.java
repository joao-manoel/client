...
public abstract class Class291 implements Interface14, Runnable, FocusListener, WindowListener {
	...
	try {
	    ...
	    Class68.aStringArray679 = (new String[] { new StringBuilder().append(".Ressurge").append(Class139.anInt1548 * -518493991).toString(), new StringBuilder().append(".file_store_").append(-518493991 * Class139.anInt1548).toString() });
